...
var file_lucy_proto_service_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x12, 0x0c, 0x2e, 0x63, 0x65, 0x72, 0x65, 0x61, 0x6c, 0x2e, 0x55, 0x55, 0x49, 0x44,
	0x1a, 0x0b, 0x2e, 0x6c, 0x75, 0x63, 0x79, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x34, 0x0a,
	0x0b, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x12, 0x16, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0b, 0x2e, 0x6c, 0x75, 0x63, 0x79, 0x2e, 0x42, 0x61, 0x74, 0x63,
	0x68, 0x30, 0x01, 0x12, 0x2e, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4a, 0x6f, 0x62,
	0x73, 0x12, 0x0d, 0x2e, 0x6c, 0x75, 0x63, 0x79, 0x2e, 0x4e, 0x65, 0x77, 0x4a, 0x6f, 0x62, 0x73,
...
type LucyClient interface {
	...
	CreateBatch(ctx context.Context, in *NewBatch, opts ...grpc.CallOption) (*cerealMessages.UUID, error)
...
func (c *lucyClient) CreateBatch(ctx context.Context, in *NewBatch, opts ...grpc.CallOption) (*cerealMessages.UUID, error) {
	out := new(cerealMessages.UUID)
...
type LucyServer interface {
	// CreateBatch creates a new batch.
	CreateBatch(context.Context, *NewBatch) (*cerealMessages.UUID, error)
	// Batch returns a single batch for a given id.
...
func (*UnimplementedLucyServer) CreateBatch(context.Context, *NewBatch) (*cerealMessages.UUID, error) {
