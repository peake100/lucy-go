...
type Batch struct {
	...
	JobCount uint32 `protobuf:"varint,7,opt,name=job_count,json=jobCount,proto3" json:"job_count,omitempty" bson:"job_count"`
	// progress is the total progress on this batch from 0.0 - 1.0.
	// @inject_tag: bson:"progress"
	Progress float32 `protobuf:"fixed32,10,opt,name=progress,proto3" json:"progress,omitempty" bson:"progress"`
	// pending_count is the number pending jobs in this batch.
	// @inject_tag: bson:"pending_count"
	PendingCount uint32 `protobuf:"varint,11,opt,name=pending_count,json=pendingCount,proto3" json:"pending_count,omitempty" bson:"pending_count"`
	// cancelled_count is the number cancelled jobs in this batch.
	// @inject_tag: bson:"cancelled_count"
	CancelledCount uint32 `protobuf:"varint,12,opt,name=cancelled_count,json=cancelledCount,proto3" json:"cancelled_count,omitempty" bson:"cancelled_count"`
	// running_count is the number running jobs in this batch.
	// @inject_tag: bson:"running_count"
	RunningCount uint32 `protobuf:"varint,13,opt,name=running_count,json=runningCount,proto3" json:"running_count,omitempty" bson:"running_count"`
	// completed_count is the number completed jobs in this batch.
	// @inject_tag: bson:"completed_count"
	CompletedCount uint32 `protobuf:"varint,14,opt,name=completed_count,json=completedCount,proto3" json:"completed_count,omitempty" bson:"completed_count"`
	// success_count is the number of successes this batch
	// @inject_tag: bson:"success_count"
	SuccessCount uint32 `protobuf:"varint,15,opt,name=success_count,json=successCount,proto3" json:"success_count,omitempty" bson:"success_count"`
	// failure count is the number of failures in this batch.
	// @inject_tag: bson:"failure_count"
	FailureCount uint32 `protobuf:"varint,16,opt,name=failure_count,json=failureCount,proto3" json:"failure_count,omitempty" bson:"failure_count"`
}
...
var file_lucy_proto_jobs_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x6a, 0x6f, 0x62, 0x43, 0x6f,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x6c, 0x65,
	0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x63,
	0x61, 0x6e, 0x63, 0x65, 0x6c, 0x6c, 0x65, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x0a,
	0x0d, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0d,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x63, 0x6f, 0x6d,
	0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x73,
	0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0f, 0x20, 0x01,
	...
	,
}
...
var file_lucy_proto_jobs_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_lucy_proto_jobs_proto_goTypes = []interface{}{
	...
	(*protogen.Error)(nil),      // 6: pkerr.Error
	(*any.Any)(nil),             // 7: google.protobuf.Any
	(*cerealMessages.UUID)(nil), // 8: cereal.UUID
}
var file_lucy_proto_jobs_proto_depIdxs = []int32{
	0,  // 0: lucy.JobStage.status:type_name -> lucy.Status
	5,  // 1: lucy.JobStage.started:type_name -> google.protobuf.Timestamp
	5,  // 2: lucy.JobStage.completed:type_name -> google.protobuf.Timestamp
	1,  // 3: lucy.JobStage.result:type_name -> lucy.Result
	6,  // 4: lucy.JobStage.error:type_name -> pkerr.Error
	7,  // 5: lucy.JobStage.result_data:type_name -> google.protobuf.Any
	8,  // 6: lucy.Job.id:type_name -> cereal.UUID
	5,  // 7: lucy.Job.created:type_name -> google.protobuf.Timestamp
	5,  // 8: lucy.Job.modified:type_name -> google.protobuf.Timestamp
	7,  // 9: lucy.Job.input:type_name -> google.protobuf.Any
	...
	8,  // 13: lucy.Batch.id:type_name -> cereal.UUID
	5,  // 14: lucy.Batch.created:type_name -> google.protobuf.Timestamp
	5,  // 15: lucy.Batch.modified:type_name -> google.protobuf.Timestamp
